...
from apps.api.network.connnect_network import CCNApi
from apps.api.network.connnect_network import CCNBackendApi
...
class CCNController(BackendController):
...
class CCNIdController(BackendIdController):
...
class CCNAddController(BackendAddController):
    allow_methods = ("POST",)
    resource = CCNBackendApi()


class CCNDeleteController(BackendDeleteController):
    name = "CCN"
    resource_describe = "CCN"
    allow_methods = ("POST",)
    resource = CCNBackendApi()


class CCNSourceController(BackendSourceController):
    name = "CCN"
    resource_describe = "CCN"
    allow_methods = ("POST",)
    resource = CCNBackendApi()
