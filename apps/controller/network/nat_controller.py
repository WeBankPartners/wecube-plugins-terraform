...
class NatGatewayAddController(BackendAddController):
    allow_methods = ("POST",)
    resource = NatGatewayBackendApi()


class NatGatewayDeleteController(BackendDeleteController):
    name = "NatGateway"
...
class NatSourceController(BackendSourceController):
    name = "NatGateway"
    resource_describe = "NatGateway"
    allow_methods = ("POST",)
    resource = NatGatewayBackendApi()
