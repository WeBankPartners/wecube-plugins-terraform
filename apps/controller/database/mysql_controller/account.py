...
from apps.api.database.mysql.account import MysqlAccountBackendApi
...
class MysqlAccountAddController(BackendAddController):
    allow_methods = ("POST",)
    resource = MysqlAccountBackendApi()




class MysqlAccountDeleteController(BackendDeleteController):
    name = "MysqlAccount"
