...
class MysqlAddController(BackendAddController):
    allow_methods = ("POST",)
    resource = MysqlBackendApi()


class MysqlDeleteController(BackendDeleteController):
    name = "Mysql"
...
class MysqlSourceController(BackendSourceController):
    name = "Mysql"
    resource_describe = "Mysql"
    allow_methods = ("POST",)
    resource = MysqlBackendApi()
...
class MysqlSGSourceController(BackendSourceController):
    name = "Mysql"
    resource_describe = "Mysql"
    allow_methods = ("POST",)
    resource = MysqlBackendApi()
