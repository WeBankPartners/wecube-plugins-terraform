...
class ResBase(object):
    ...
    def create(cls, resource, data, **kwargs):
        ...
        d = dict(version=version, port=port,
                 ...
                 subnet_id=subnet_id, charge_typ=charge_type)
...
class MariaDBController(BackendController):
...
class MariaDBIdController(BackendIdController):
...
class MariaDBAddController(BackendAddController):
    allow_methods = ("POST",)
    resource = MariaDBBackendApi()


class MariaDBDeleteController(BackendDeleteController):
    name = "MariaDB"
...
class MariaDBSourceController(BackendSourceController):
    name = "MariaDB"
    resource_describe = "MariaDB"
    allow_methods = ("POST",)
    resource = MariaDBBackendApi()
...
class MariaDBSGSourceController(BackendSourceController):
    name = "MariaDB"
    resource_describe = "MariaDB"
    allow_methods = ("POST",)
    resource = MariaDBBackendApi()
