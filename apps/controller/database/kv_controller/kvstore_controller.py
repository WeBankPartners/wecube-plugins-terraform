...
class KvStoreAddController(BackendAddController):
    allow_methods = ("POST",)
    resource = KvStoreBackendApi()


class KvStoreDeleteController(BackendDeleteController):
    name = "KvStore"
...
class KvStoreSourceController(BackendSourceController):
    resource_describe = "KvStore"
    allow_methods = ("POST",)
    resource = KvStoreBackendApi()


class KvStoreSGSourceController(BackendSourceController):
    resource_describe = "KvStore"
    allow_methods = ("POST",)
    resource = KvStoreBackendApi()
