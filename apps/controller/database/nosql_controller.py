...
class NosqlController(BackendController):
...
class NosqlActionController(BackendController):
    allow_methods = ('PATCH',)
    resource = NosqlApi()
...
class NosqlAddController(BaseController):
    allow_methods = ("POST",)
    resource = NosqlApi()
...
class NosqlDeleteController(BaseController):
    name = "Nosql"
    resource_describe = "Nosql"
    allow_methods = ("POST",)
    resource = NosqlApi()
