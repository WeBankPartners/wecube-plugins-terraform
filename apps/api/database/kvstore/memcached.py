...
class MemcachedBackendApi(KvStoreBackendApi):
    def __init__(self):
        super(MemcachedBackendApi, self).__init__()
        self.resource_name = "memcached"
        self.resource_workspace = "memcached"
        self._flush_resobj()
        self.resource_keys_config = None
...
class MemcachedBackupBackendApi(KvBackupBackendApi):
    def __init__(self):
        super(MemcachedBackupBackendApi, self).__init__()
        self.resource_name = "memcached_backup"
        self.resource_workspace = "memcached_backup"
        self._flush_resobj()
        self.resource_keys_config = None
