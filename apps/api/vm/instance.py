...
class InstanceApi(object):
    ...
    def save_data(self, rid, name, provider, region, zone,
                  ...
                  status, result_json):
        InstanceObject().create(create_data={"id": rid, "provider": provider,
    ...
    def update_data(self, rid, data):
        InstanceObject().update(rid, data)
...
class InstanceAttachObject(object):
    def __init__(self):
        self.resource = InstanceAttachManager()
