...
def _validate_query_data(provider, key, value, define, resource_value_config, resource_name):
    '''
...
def query_data_builder(provider, datas, defines, resource_values_config, resource_name):
    '''
